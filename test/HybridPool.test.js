...
describe('HybridPoolBase Implementation', () => {
    it('should calculate the USD value of the pool based on the last captured ratio of token/Asset in the oracle', async () => {
        await runTest({
            reserves: {token: bn(1), asset: bn(1)},
        ...
        await runTest({
            reserves: {token: bn(0.5), asset: bn(1)},
        ...
        await runTest({
            reserves: {token: bn(2), asset: bn(1)},
        ...
        await runTest({
            reserves: {token: bn(100), asset: bn(10)},
    ...
    it('should calculate the USD value of the pool based on amount of backing asset + token in the pool', async () => {
        await runTest({
            reserves: {token: bn(0), asset: bn(0)},
            capture: {ratio: ratio(1.0), valid: true},
            assetPrice: bn(1),
            univ2Supply: bn(1),
            univ2Bonded: bn(1),
        ...
        await runTest({
            reserves: {token: bn(0.1), asset: bn(0.1)},
            capture: {ratio: ratio(1.0), valid: true},
            assetPrice: bn(1),
            univ2Supply: bn(1),
            univ2Bonded: bn(1),
        ...
        await runTest({
            reserves: {token: bn(0.2), asset: bn(0.2)},
            capture: {ratio: ratio(1.0), valid: true},
            assetPrice: bn(1),
            univ2Supply: bn(1),
            univ2Bonded: bn(1),
        ...
        await runTest({
            reserves: {token: bn(2), asset: bn(2)},
            capture: {ratio: ratio(1.0), valid: true},
            assetPrice: bn(1),
            univ2Supply: bn(1),
            univ2Bonded: bn(1),
        ...
        await runTest({
            reserves: {token: bn(99999999), asset: bn(99999999)},
            capture: {ratio: ratio(1.0), valid: true},
            assetPrice: bn(1),
            univ2Supply: bn(1),
            univ2Bonded: bn(1),
    ...
    it('should work as expected with backing assets of a differing number of decimals', async () => {
        ...
        await runTest({
            reserves: {token: bn(1), asset: new BN("1000000")},
            capture: {ratio: ratio(1.0), valid: true},
            assetPrice: bn(1),
            univ2Supply: bn(1),
            univ2Bonded: bn(1),
        ...
        await runTest({
            reserves: {token: bn(1), asset: new BN("1")},
            capture: {ratio: ratio(1.0), valid: true},
            assetPrice: bn(1),
            univ2Supply: bn(1),
            univ2Bonded: bn(1),
        ...
        await runTest({
            reserves: {token: bn(1), asset: new BN("1000000000000000000000")},
            capture: {ratio: ratio(1.0), valid: true},
            assetPrice: bn(1),
            univ2Supply: bn(1),
            univ2Bonded: bn(1),
    ...
    const setReserves = ({token, asset}) =>
        this.pool.setReserves(token, asset)
    ...
    const setup = async ({decimals}) => {
        ...
        this.liquidity = await MockUniswapV2PairLiquidity.new(this.token.address, this.mockToken.address, {from: mockDaoAddress})
