...
contract HybridPoolGetters is HybridPoolState {
    ...
    function gold() public view returns (IToken) {
        return IToken(Constants.getGoldAddress());
    }
    ...
    function totalRewarded(IToken gold) public view returns (uint256) {
    ...
    function balanceOfRewarded(address account, IToken gold) public view returns (uint256) {
